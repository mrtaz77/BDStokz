...
BEGIN
  ...
  LOOP 
    ...
    LOOP 
      JSON_DATA := JSON_DATA || '{"x":'||(TO_NUMBER(TO_CHAR(CURR_DATE, 'J')) - 2440587.5)*86400000 || ',"y":'||0||'}';
    ...
    JSON_DATA := JSON_DATA || '{"x":'||(TO_NUMBER(TO_CHAR(R.DAT, 'J')) - 2440587.5)*86400000 || ',"y":'||R.AVG_PRICE||'}';
...
BEGIN
	...
	INSERT INTO ADMIN_LOG(EVENT_TYPE,DESCRIPTION) VALUES ('PURCHASE',BUYER_ID||' purchased '||NUM_LOT_SOLD||' number of lots of '||ORDER_SYM||' at price '||LATEST_PRICE||' from '||SELLER_ID);
